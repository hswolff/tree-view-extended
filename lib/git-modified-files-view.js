...
export default class GitModifiedFilesView extends ExtendedBase {
  constructor() {
    super();
    this.createObservers({ stickyKey: 'stickyGitModifiedFiles' });
    ...
    getRepositories().then(repos => {
      for (const repo of repos) {
        ...
        const updateView = () => {
          ...
          const allPaneItems = atom.workspace.getPaneItems();
        ...
        this.viewSubs.add(atom.workspace.onDidStopChangingActivePaneItem((activeItem) => {
          updateView();
